...
if __name__ == "__main__":
    ...
    main = pd.DataFrame()
    months=['2017-01','2017-02','2017-03','2017-04','2017-05','2017-06','2017-07','2017-08','2017-09','2017-10','2017-11','2017-12','2018-01']
    ...
    result = main.to_json("Result_parallel.json",orient="records",lines=True)
